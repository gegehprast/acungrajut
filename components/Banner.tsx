...
const Banner = () => {
    return <svg className='absolute w-auto h-[60vh] align-middle -right-1/4 lg:right-0 lg:w-full lg:h-auto ' 
    ...
    >
        <g id="Banner">
            ...
            <rect id="Image Frame" x="739.583" y="360" width="483.678" height="483.678" transform="rotate(-11.7314 739.583 360)" fill="url(#pattern0)"/>
            <g id="Lower - Mask Group">
                <mask id="mask0_16_65" style={{ maskType: 'alpha' }} maskUnits="userSpaceOnUse" x="739" y="261" width="573" height="573">
                    <rect id="Image Frame_2" x="746.678" y="364.655" width="471.678" height="471.678" transform="rotate(-11.7314 746.678 364.655)" stroke="#F06095" strokeWidth="12"/>
                </mask>
            ...
            <g id="Upper - Mask Group">
                <mask id="mask1_16_65" style={{ maskType: 'alpha' }} maskUnits="userSpaceOnUse" x="739" y="261" width="573" height="573">
                    <rect id="Image Frame_3" x="746.678" y="364.655" width="471.678" height="471.678" transform="rotate(-11.7314 746.678 364.655)" stroke="#FFB1CE" strokeWidth="12"/>
                </mask>
