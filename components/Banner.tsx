...
const Banner = () => {
    return <svg className='absolute top-0 h-full -right-[10rem] md:-right-[13rem] xl:right-0' 
        viewBox="0 0 400 187" 
        fill="none" 
    ...
    >
        ...
        <rect x="253.938" y="87.3568" width="92" height="92" rx="7" transform="rotate(-12.8233 253.938 87.3568)" fill="url(#pattern0)" stroke="#FFB1CE" strokeWidth="0"/>
